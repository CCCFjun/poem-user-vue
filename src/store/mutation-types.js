...
export const INIT_FILLTWO_ANSWERS_LENGTH = 'init_fillTwo_answers_length' // 初始化填空题er答案数组长度
...
export const RECORD_FILLTWO_ANSWERS = 'record_fillTwo_answers'
...
export const REFRESH_FILLTWO_ANSWERS = 'refresh_fillTwo_answers' 
